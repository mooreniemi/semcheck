module Words
  ...
  SCHEMAS = [
    "https://schema.org/HousePainter", "https://schema.org/Residence", "https://schema.org/JobPosting", "https://schema.org/RentAction", "https://schema.org/Organization", "https://schema.org/VideoGame", "https://schema.org/PostalAddress", "https://schema.org/Game", "https://schema.org/Product", "https://schema.org/", "https://schema.org/AggregateOffer", "https://schema.org/LocalBusiness", "https://schema.org/Corporation", "https://schema.org/Store", "https://schema.org/Person?ext=bib", "https://schema.org/Text", "https://bib.schema.org/Newspaper"
  ]
end
